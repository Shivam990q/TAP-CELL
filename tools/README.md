...
```
python tools/build_resume.py 04-resume/tailored/<company>/<file>.tex --preview
```
...
- `06-job-descriptions/<company>/<slug>.md` (paste the JD)
...
2. Paste the JD into the generated `06-job-descriptions/<company>/<slug>.md`.
3. Tailor `04-resume/tailored/<company>/<slug>.tex` (role subtitle, skills order, projects).
4. `python tools/build_resume.py 04-resume/tailored/<company>/<slug>.tex --preview`
